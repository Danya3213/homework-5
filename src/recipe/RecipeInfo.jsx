import LiStyled from './styled components/li';
import RowStyled from './styled components/row';
import H2Styled from './styled components/h2';
import H3Styled from './styled components/h3';
import Container from './styled components/container';
import SpanStyled from './styled components/span';
        ...
        <LiStyled>
            ...
            <RowStyled className="recipe__info">
                ...
                <div>
                    ...
                    <h3>{props.calories} calories</h3>
                </div>
            </RowStyled>
            <RowStyled>
                <H3Styled>Difficulty</H3Styled>
                <Container>
                    <SpanStyled className={props.difficulty === 0 ? 'active' : ''}>Easy</SpanStyled>
                    <SpanStyled className={props.difficulty === 1 ? 'active' : ''}>Medium</SpanStyled>
                    <SpanStyled className={props.difficulty === 2 ? 'active' : ''}>Hard</SpanStyled>
                </Container>
            </RowStyled>
        </LiStyled>
    );
